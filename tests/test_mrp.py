...
class TestMRPInicializacao(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.diretorio_testes = "dados"  # Diretório com os arquivos de teste
    ...
    def criar_arquivos_bom_teste(self):
        ...
        workbook_eti.save(os.path.join(self.diretorio_testes, "ETI_BOM.xlsx"))
        ...
        workbook_etf.save(os.path.join(self.diretorio_testes, "ETF_BOM.xlsx"))
